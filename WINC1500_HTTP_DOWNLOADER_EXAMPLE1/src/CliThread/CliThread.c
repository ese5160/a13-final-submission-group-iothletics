...
static const CLI_Command_Definition_t xHapticMotor = {"haptic",
													  "haptic: Start vibrating the Haptic Motor using the DRV2605L motor driver \r\n",
													  (const pdCOMMAND_LINE_CALLBACK)CLI_HapticMotorDriver, 0};  
													  
static const CLI_Command_Definition_t xLoadCell = {"load",
												   "load: Know how much weight is on the Lad Cell \r\n",
												   (const pdCOMMAND_LINE_CALLBACK)CLI_LoadCell, 0};
...
void vCommandConsoleTask(void *pvParameters)
{
	...
	FreeRTOS_CLIRegisterCommand(&xHapticMotor);
	FreeRTOS_CLIRegisterCommand(&xLoadCell);
    ...
    // Any semaphores/Mutex/etc you needed to be initialized, you can do them here
...
BaseType_t CLI_GetImuData(int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString)
{
    ...
    if (reg) {
        ...
        snprintf((char *)pcWriteBuffer, xWriteBufferLen, "Acceleration [mg]:\r\nX %d\r\nY: %d\r\nZ: %d\r\n", (int)acceleration_mg[0], (int)acceleration_mg[1], (int)acceleration_mg[2]);
...
BaseType_t CLI_HapticMotorDriver(int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString){
...
BaseType_t CLI_LoadCell(int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString){
